...
Como dito, os códigos armazenados neste repositório são utilizados em um projeto de pesquisas empíricas quantitativas acerca da produção normativa da Receita Federal do Brasil (RFB), desde a promulgação da Constituição Federal, em 1988. Essa pesquisa já deu origem a uma [publicação acadêmica](https://periodicos.fgv.br/revdireitogv/article/view/91354) cujo objetivo foi trazer para o debate público brasileiro um tema que, apesar de ser de grande importância para o desenvolvimento econômico do país, ainda não foi objeto de investigações científicas sistemáticas.
